...
exports.googleAsstWebHookResponse = function(req,res){
    ...
    if(req.body.result.metadata.intentName=='ServiceNowStoreData'){ 
        ...
        displayText:"Your service now request created successfully. Your Incident number is :  "+data.result.number
                    ...
                    return res.json({
                        speech:"something went wrong with the request",
                        displayText: "something went wrong with the request"
        ...
        return res.json({
            speech:"something went wrong on the request.Sorry for the inconvience caused",
            displayText: "something went wrong on the request.Sorry for the inconvience caused"
        })
    }
        ...
        if(req.body.result.metadata.intentName=='serviceNowGenerateId'){
            ...
            return res.json({
                speech:"Please state the priority of the incident"
                ,displayText:"Please state your priority of the incident"
            })
      /*  return res.json({
            "messages": [
                {
            ...
            if(req.body.result.metadata.intentName =='serviceNowGetDetails'){
                ...
                if(req.body.result.parameters.empid.length>3 && req.body.result.parameters.empid.length<7){
                    res.json({
                        speech:"Please state the type of incident",
                        displayText:"Please state the type of incident"
                    })
                    /*res.json({
                        "messages": [
                            {"type":0,
